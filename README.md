...
#cursor is a tool  like mouse, basically going to use this as our mouse interact with mysql
#database if we can use do stuff like execute commands select rows and columns
#return some data we can do a whole bunch of things with this cursor
...
def focus7(event): 
    ...
    how_you_came_to_know_field.focus_set() 
  
  
# Function to set focus 
def focus8(event): 
    # set focus on the address_field box 
    experience_or_fresher_field.focus_set() 
# Function to set focus 
def focus9(event):
    # set focus on the address_field box 
    contact_person_field.focus_set()

# Function to set focus 
def focus10(event):
    # set focus on the address_field box 
    counselor_field.focus_set()

# Function to set focus 
def focus11(event):
    # set focus on the address_field box 
    fees_field.focus_set()
...
def clear(): 
    ...
    batch_preferred_field.delete(0,END)
    how_you_came_to_know_field.delete(0,END)
    experience_or_fresher_field.delete(0,END)
    contact_person_field.delete(0,END)
    counselor_field.delete(0,END)
    fees_field.delete(0,END)
...
def insert():
    print(date_field.get())
    print(name_field.get())
    print(mobile_no_field.get())
    print(alternate_no_field.get())
    print(email_id_field.get())
    print(address_field.get())
    print(course_field.get())
    print(batch_preferred_field.get())
    print(how_you_came_to_know_field.get())
    print(experience_or_fresher_field.get())
    print(contact_person_field.get())
    print(counselor_field.get())
    print(fees_field.get())
    print(comment_field.get())
    print (regDetails.get())
    ...
    if (name_field.get() == "" and
        ...
        date_field.get() == "" and
        batch_preferred_field.get()=="" and
        how_you_came_to_know_field.get()=="" and
        experience_or_fresher_field.get()=="" and
        contact_person_field.get()=="" and
        counselor_field.get()=="" and
        fees_field.get()=="" and
        comment_field.get()==""):
	...
	# Data inserting into database Start
        if regDetails.get() == 1 and EnquiryDetails.get() == 1:
                insert_reg_record = "INSERT INTO Registration(Date,Name,mobail_no,alternate_no,Email,address,course,batch,how_you_know,EXPERIENCE,contact_prson,counselor,fees,comment)VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');"%(date_field.get(),name_field.get(),mobile_no_field.get(),alternate_no_field.get(),email_id_field.get(),address_field.get(),course_field.get(),batch_preferred_field.get(),how_you_came_to_know_field.get(),experience_or_fresher_field.get(),contact_person_field.get(),counselor_field.get(),fees_field.get(),comment_field.get())
                insert_Enquiry_record ="INSERT INTO enquiry(Date,Name,mobail_no,alternate_no,Email,address,course,batch,how_you_know,EXPERIENCE,contact_prson,counselor,fees,comment)VALUES('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');"%(date_field.get(),name_field.get(),mobile_no_field.get(),alternate_no_field.get(),email_id_field.get(),address_field.get(),course_field.get(),batch_preferred_field.get(),how_you_came_to_know_field.get(),experience_or_fresher_field.get(),contact_person_field.get(),counselor_field.get(),fees_field.get(),comment_field.get())
...
if __name__ == "__main__": 
    ...
    course_field.bind("<Return>", focus6) 
    batch_preferred_field.bind("<Return>", focus7)
    how_you_came_to_know_field.bind("<Return>",focus8)
    experience_or_fresher_field.bind("<Return>",focus9)
    contact_person_field.bind("<Return>",focus10)
    counselor_field.bind("<Return>",focus11)
    fees_field.bind("<Return>",focus12)
    ...
    Checkbutton(root, text="Registration", variable=regDetails).grid(row=15,column=1, sticky=N)
